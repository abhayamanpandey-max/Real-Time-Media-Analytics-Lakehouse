...
<head>
    ...
    <script>
        ...
        window._submitQuestion = async function(question) {
            ...
            loadMsg.innerHTML = '<div class="h-6 px-1 py-0.5 bg-white border border-slate-200 rounded-md flex items-center justify-center shrink-0 mt-0.5 shadow-xs"><img src="/static/tenetic_logo.png" onerror="this.onerror=null;this.src='data:image/png;base64,'" alt="Tenetic" class="h-3.5 w-auto object-contain" /></div><div class="text-sky-800 text-xs py-0.5"><div class="font-bold flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-sky-600 animate-ping"></span> Querying Lakehouse Agent...</div><div class="text-[10px] text-slate-500 mt-0.5">Routing to Databricks Genie AI (typically 10-15s)</div></div>';
            ...
            try {
                ...
                if (resp.ok) {
                    ...
                    agentMsg.innerHTML = '<div class="h-6 px-1 py-0.5 bg-white border border-slate-200 rounded-md flex items-center justify-center shrink-0 mt-0.5 shadow-xs"><img src="/static/tenetic_logo.png" onerror="this.onerror=null;this.src='data:image/png;base64,'" alt="Tenetic" class="h-3.5 w-auto object-contain" /></div><div class="markdown-body text-xs text-slate-800 leading-relaxed bg-white border border-slate-200 p-3.5 rounded-2xl rounded-tl-sm flex-1 shadow-sm">' + window.formatBusinessAnswer(data.answer) + '</div>';
...
<body class="min-h-screen flex flex-col relative bg-slate-50 text-slate-900 selection:bg-sky-500 selection:text-white">
    ...
    <header class="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex items-center justify-between shadow-sm">
        <div class="flex items-center gap-3">
            <a href="#" class="flex items-center gap-2 group">
                <img src="/static/tenetic_logo.png" onerror="this.onerror=null;this.src='data:image/png;base64,'" alt="TENETIC" class="h-9 w-auto object-contain" />
            </a>
    ...
    <!-- Hero Section -->
    <section id="about" class="px-6 pt-16 pb-20 max-w-6xl mx-auto text-center flex flex-col items-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4 mt-8">
            <button onclick="window.toggleChat(true)" class="bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs px-7 py-4 rounded-xl shadow-lg shadow-slate-900/20 transition-all flex items-center gap-2 cursor-pointer border border-slate-700">
        ...
        <!-- Real Telecast Control Room Showcase Frame -->
        <div class="w-full max-w-5xl mt-14 relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200 bg-slate-950 group">
            <img 
                ...
                class="w-full h-72 sm:h-96 object-cover opacity-60 group-hover:scale-102 transition-transform duration-700 ease-out" 
            />
            <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent flex flex-col justify-between p-6 sm:p-8 text-left">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                    ...
                    <div class="bg-slate-900/85 backdrop-blur-md border border-slate-700/80 p-4 rounded-2xl shadow-sm">
                        ...
                        <div class="text-xl font-bold text-white mt-1">Connected TV Lead</div>
                        <div class="text-xs text-indigo-400 font-mono mt-0.5 font-bold">24.42% CTV • 22.8% Browser</div>
                    </div>
                    <div class="bg-slate-900/85 backdrop-blur-md border border-slate-700/80 p-4 rounded-2xl shadow-sm">
                        <div class="text-[10px] uppercase font-mono text-slate-400">Lakehouse Verification</div>
                        <div class="text-xl font-bold text-white mt-1">Databricks Photon</div>
                        <div class="text-xs text-emerald-400 font-mono mt-0.5 font-bold">Verified Delta Gold Layer</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-5xl mt-10 text-left">
    ...
    <section id="telecasts" class="py-16 bg-white border-y border-slate-200 px-6">
        <div class="max-w-6xl mx-auto">
            <div class="text-center max-w-2xl mx-auto mb-12">
                ...
                <p class="text-xs sm:text-sm text-slate-600 mt-3">From live NFL / sports broadcasts and national network events to local station telecasts across the country, Tenetic converts broadcast telemetry into certified advertising value.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Card 1: Broadcast Telecast Studio -->
                <div class="rounded-2xl bg-slate-50 border border-slate-200 overflow-hidden shadow-xs flex flex-col">
                ...
                <div class="rounded-2xl bg-slate-50 border border-slate-200 overflow-hidden shadow-xs flex flex-col">
                    ...
                    <div class="p-5 flex-1 flex flex-col justify-between">
                        <div>
                            ...
                            <p class="text-xs text-slate-600 leading-relaxed">
                                Empowers regional sales teams across US metro areas (New York, Los Angeles, Chicago, Dallas, Atlanta) to prove inventory value to local advertisers with verified precision.
                            </p>
                        </div>
                        <div class="mt-4 pt-3 border-t border-slate-200 text-[11px] font-bold text-indigo-700 flex items-center gap-1.5">
                            <span class="w-1.5 h-1.5 rounded-full bg-indigo-600"></span> Regional Station Valuation Engine
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-2xl bg-slate-50 border border-slate-200 overflow-hidden shadow-xs flex flex-col">
                    <div class="h-44 w-full relative overflow-hidden bg-slate-900">
                        <img 
                            ...
                            class="w-full h-full object-cover opacity-90 hover:scale-105 transition-transform duration-500" 
                        />
                        <div class="absolute top-3 left-3 bg-slate-900/80 backdrop-blur-md px-2.5 py-1 rounded-md text-[10px] font-mono font-bold text-purple-400 border border-slate-700">
                            SURVEY & ATTITUDINAL AI
                        </div>
                    </div>
                    <div class="p-5 flex-1 flex flex-col justify-between">
                        <div>
                        ...
                        <div class="mt-4 pt-3 border-t border-slate-200 text-[11px] font-bold text-purple-700 flex items-center gap-1.5">
    ...
    <footer class="mt-auto border-t border-slate-200 bg-white px-6 py-8 text-xs text-slate-500">
        <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <img src="/static/tenetic_logo.png" onerror="this.onerror=null;this.src='data:image/png;base64,'" alt="Tenetic" class="h-7 w-auto object-contain" />
    ...
    <div class="fixed bottom-5 right-5 z-50">
        <button 
            ...
            id="chatToggleBtn"
            class="bg-slate-900 hover:bg-slate-800 text-white font-bold px-4 py-2.5 rounded-full shadow-2xl shadow-slate-900/40 flex items-center gap-2.5 transition-all border border-slate-700 cursor-pointer group"
        >
            <div class="h-6 px-1.5 py-0.5 bg-white rounded-md flex items-center justify-center">
                <img src="/static/tenetic_logo.png" onerror="this.onerror=null;this.src='data:image/png;base64,'" alt="Tenetic" class="h-4 w-auto object-contain" />
            </div>
    ...
    >
        ...
        <div class="bg-slate-900 border-b border-slate-800 p-3.5 px-4 flex items-center justify-between shrink-0 text-white">
            <div class="flex items-center gap-3">
                <div class="h-8 px-2 py-1 bg-white rounded-lg flex items-center justify-center shadow-xs">
                    <img src="/static/tenetic_logo.png" onerror="this.onerror=null;this.src='data:image/png;base64,'" alt="Tenetic" class="h-5 w-auto object-contain" />
                </div>
                <div>
